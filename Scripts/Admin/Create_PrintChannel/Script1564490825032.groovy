...
WebUI.click(findTestObject('Admin/Channels/Print/select_PrintQueue'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Admin/Channels/Email/input_name'), '2_TesT_PrintConneCTIon1!@', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Admin/Channels/Email/textarea_description'), 'This is a Print connection that connects a Printer. !@#$1234{}][;\'\\:"|<>?/.,)(*&^%+_-=ÆØÅ', 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Admin/Channels/Print/setText_PrinterName'), GlobalVariable.Printer_Name, FailureHandling.CONTINUE_ON_FAILURE)
