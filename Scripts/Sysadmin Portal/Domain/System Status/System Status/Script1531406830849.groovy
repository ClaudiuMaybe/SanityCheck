...
WebUI.click(findTestObject('Sysadmin Portal/Domain/System_Status link'))

WebUI.delay(3)


table = CustomKeywords.'kms.turing.katalon.plugins.helper.table.HTMLTableHelper.identifyTableByColumnHeaders'(['Service','Health','Additional Information'], 10,  FailureHandling.CONTINUE_ON_FAILURE)

"Identify a cell by it's value and column header"
cellName = CustomKeywords.'kms.turing.katalon.plugins.helper.table.HTMLTableHelper.identifyCellByValueAndColHeader'(table, "Service", "Trigger Service - 127.0.0.1:40020" ,  FailureHandling.CONTINUE_ON_FAILURE)
